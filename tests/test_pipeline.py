...
def test_convert_returns_dict(synthetic_xml_bytes):
    from converter import convert
    out = convert(synthetic_xml_bytes)
    assert isinstance(out, dict)


def test_convert_has_expected_keys(synthetic_xml_bytes):
    from converter import convert
    out = convert(synthetic_xml_bytes)
...
def test_convert_report_dict_shape(synthetic_xml_bytes):
    from converter import convert
    out = convert(synthetic_xml_bytes)
    rep = out["report"]
...
def test_convert_rdl_is_valid_xml(synthetic_xml_bytes):
    from converter import convert
    out = convert(synthetic_xml_bytes)
    rdl = out["rdl_xml"]
...
def test_convert_oracle_xml_round_tripped(synthetic_xml_bytes):
    from converter import convert
    out = convert(synthetic_xml_bytes)
...
def test_convert_mockup_html_present(synthetic_xml_bytes):
    from converter import convert
    out = convert(synthetic_xml_bytes)
...
def test_convert_size_bounds(synthetic_xml_bytes):
...
def test_convert_validation_issues_present_if_supported(synthetic_xml_bytes):
...
def test_convert_deterministic(synthetic_xml_bytes):
    """Calling convert twice on the same input should produce identical reports."""
    from converter import convert
    a = convert(synthetic_xml_bytes)
    b = convert(synthetic_xml_bytes)
